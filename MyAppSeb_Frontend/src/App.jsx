...
// Componente Card renderizando las imágenes de los iconos
function CardItem({ item }) {
  const { title, bgColor, optionNum, iconUrl, rotation } = item;
  
  return (
    <div className={`group relative cursor-pointer transform transition-all duration-300 ${rotation} hover:scale-105 hover:z-30 mt-4`}>
      
      {/* Sombra posterior sólida */}
      <div 
      ...
      {/* Tarjeta Principal Interna (Aumentada a h-64 para dar espacio a los iconos grandes) */}
      <div
      ...
      >
        ...
        {/* Imagen del Icono P5 (Aumentado a w-32 h-32) */}
